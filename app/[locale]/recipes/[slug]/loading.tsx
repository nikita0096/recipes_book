...
// Shown instantly on navigation to a recipe while the server component awaits
// auth, the like state and fetchRecipeServer. Without a loading boundary at
// this segment the previous page would stay frozen until that work resolves
// (the [locale] loading.tsx doesn't fire because that layout is preserved when
// navigating between sibling routes). The skeleton mirrors the hero + meta so
// there's no layout shift when the real page swaps in.
const RecipeLoading = () => {
  return (
