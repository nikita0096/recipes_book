...
export interface CakeAssemblyRecipe {
  id: string;
  title?: LocalizedText,
  steps_count?: number,
...
const HomePage = ({cakeAssemblyData, animatedWordsList} : HomePageProps) => {
  ...
  return (
    <div className="relative -mt-[65px]">
      ...
      <AnimatedHero
        ...
        wordsList={animatedWordsList}
      />

      {/* Cake Hero Section */}
      <CakeAssembly scrollText={t('hero.scroll')} cakeAssemblyData={cakeAssemblyData}/>
