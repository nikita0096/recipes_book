        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-linear-to-br from-[#a67c52] to-[#d4a574] rounded-2xl flex items-center justify-center shadow-lg shadow-amber-500/30">
                <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                </svg>
              </div>
              <div>
                <h3 className="text-2xl font-bold bg-linear-to-r from-[#a67c52] to-[#d4a574] bg-clip-text text-transparent">
                  Yuliia&apos;s Recipes
                </h3>
          ...
          {/* Quick links */}
          <div>
            <h4 className="text-lg font-semibold mb-6 flex items-center gap-2 text-text">
            ...
            <nav className="space-y-3">
              <Link
                href={PAGES.HOME}
                className="block text-gray-400 hover:text-accent transition-colors duration-300 hover:translate-x-1 transform"
              >
                {t('quickLinks.home')}
              </Link>
              <Link
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Yuliia&apos;s Recipes. {t('copyright')}
            </p>
          </div>
        </div>
      </div>
