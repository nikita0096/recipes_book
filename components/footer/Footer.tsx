        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-500 hover:via-pink-500 hover:to-orange-500 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
          ...
          <div>
            <h4 className="text-lg font-semibold mb-6 flex items-center gap-2">
              <span className="w-8 h-0.5 bg-gradient-to-r from-amber-400 to-orange-400 rounded-full" />
              {t('quickLinks.title')}
            </h4>
            <nav className="space-y-3">
              <Link
                href={PAGES.HOME}
                className="block text-gray-400 hover:text-amber-400 transition-colors duration-300 hover:translate-x-1 transform"
              >
                {t('quickLinks.home')}
              </Link>
              <Link
